...
export default async function ReportsPage({
  ...
  // Hitung jumlah match per laporan.
  ...
  const tabs = [
    {
      key: "lost",
      label: `Lost Reports (${lost.length})`,
      href: "/reports?tab=lost",
    },
    {
      key: "found",
      label: `Found Reports (${found.length})`,
      href: "/reports?tab=found",
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <PageHeader
        title="Laporan Saya"
        description="Semua laporan kehilangan dan penemuan yang Anda buat."
      />
